...
class EditBookCatgeory extends StatefulWidget {
  final DocumentSnapshot ds;
  const EditBookCatgeory({super.key, required this.ds});

  @override
  State<EditBookCatgeory> createState() => _EditBookCatgeoryState();
}

class _EditBookCatgeoryState extends State<EditBookCatgeory> {
  ...
  void initState() {
    ...
    String imageUrl = widget.ds['BookCategoryImage'];
    bytes = base64Decode(imageUrl);
    // Set image1 to null, as we are displaying image23 by default
    image1 = null;
    updatedmuiccatname.text=widget.ds['BookCategoryName'];
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: '${widget.ds['BookCategoryName']}',
      ...
      imageUrl = '${base64Image}';
                  ...
                  Map<String, dynamic> updateBookCat = {
                    "BookCategoryName": updatedmuiccatname.text,
                    "BookCategoryImage": imageUrl,
                    "Id":widget.ds.id,
                  };
                  await fireDatabase().updateBookCategory(widget.ds.id, updateBookCat).then((value) {
